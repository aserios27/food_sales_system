...
# (1) 제품 생성 매서드 
            ...
            while True:
                ...
                if in_code != '' :
                    ...
                    #2) 같은 제품코드가 존재하지 않는 경우
                        ...
                        super().prodHisCreate(in_code, iValue) # 2023-03-21 history 테이블 데이터 추가
                        print("제품등록을 성공했습니다.")
                        break
            ...
            while True:
                ...
                if rows_c1 :
                    ...
                    if SelOpt(yesNo).startOpt(): 
                        ...
                        super().prodHisUpdate(in_code) # 2023-03-21 / 이력관리 테이블 추가 
    ...
    def abolitionProdRead(self) :
        print(f"제품정보 조회(삭제내역) ")
        sql = "SELECT Code, pName, unitPrice, discountRate FROM product_history WHERE Event = 'Delete'"
        rows = sqlAction(sql)
